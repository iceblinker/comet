...
* add database indexes for performance optimization across multiple tables ([c806078](https://github.com/iceblinker/comet/commit/c80607871ee9c0101bdb5a4757eaeb2cc3d10087))
...
* add handling for empty torrent lists in filter_manager ([aef2549](https://github.com/iceblinker/comet/commit/aef2549f3697707a433a4ff459703a27aa1623b4))
...
* add live torrent cache TTL and update related settings ([6e2e420](https://github.com/iceblinker/comet/commit/6e2e420d7379824d9b76ca603703f914349cf20b))
...
* add logging for scraper activity in TorrentManager ([6324112](https://github.com/iceblinker/comet/commit/63241126a2980f54230412e4a63e904b9e0804a5))
...
* add metrics caching functionality and update settings for metrics cache TTL ([e3c269b](https://github.com/iceblinker/comet/commit/e3c269ba050be48a834bbf9cbe0609415362cee7))
...
* Add NO_CACHE_HEADERS and update FileResponse usage in streaming ([52dce02](https://github.com/iceblinker/comet/commit/52dce02b98417139b2afd775e5c23b8f51eb6f0a))
...
* add YGGTorrent scraper ([4a677bf](https://github.com/iceblinker/comet/commit/4a677bf773f6e6351aee698b137b467bb23473ae))
* add YGGTorrent scraper ([2317e88](https://github.com/iceblinker/comet/commit/2317e884e215c4f6367d05b19d77e1971fccf612))
...
* bitmagnet scraper ([26e3e5e](https://github.com/iceblinker/comet/commit/26e3e5eb757c515c6335ad72cdb4547d833b46d7))
* bitmagnet scraper ([3619fe5](https://github.com/iceblinker/comet/commit/3619fe50849cab54f84070e7e79a78926d9fa03f))
...
* different modes for scrapers (live/background/both) ([b27e6ad](https://github.com/iceblinker/comet/commit/b27e6adebaa4a311aa6a9144595bd94259cb9bfc))
* different modes for scrapers (live/background/both) ([278a130](https://github.com/iceblinker/comet/commit/278a130d009d07cfadd363b6e9c4e125ee30279f))
...
* enhance admin dashboard with dynamic tracker limit selection and optimize database metrics query ([5df4121](https://github.com/iceblinker/comet/commit/5df412125bbd668661473a5512f1f9c0b22d6b93))
...
* enhance Nyaa scraper with anime-only option and integrate anime mapping functionality ([f9c361c](https://github.com/iceblinker/comet/commit/f9c361cc7d05f39911822b2b2780d86613ca74d7))
* enhance Nyaa scraper with anime-only option and integrate anime… ([a424f81](https://github.com/iceblinker/comet/commit/a424f8181a418a04c28434e8258be53bf759cbda))
* enhance Nyaa scraper with Kitsu-only option ([1b5b734](https://github.com/iceblinker/comet/commit/1b5b7344c426b08521de4074f7d297b6a12377a5))
* enhance playback functionality with media_id and aliases support ([eb9cbdc](https://github.com/iceblinker/comet/commit/eb9cbdc680a491575457af6f8c8ac198533f8895))
...
* Enhance URL encoding by using `safe=''` in `quote` calls for playback and magnet URIs ([5664a86](https://github.com/iceblinker/comet/commit/5664a86eeb9a991796ff0d60e3c79f8bdbb5532d))
* Enhance URL encoding by using `safe=''` in `quote` calls for playback and magnet URIs ([96a962f](https://github.com/iceblinker/comet/commit/96a962faac555390bb9c461e345542324bdeb372))
...
* fix Debridio scraper ([85c0aee](https://github.com/iceblinker/comet/commit/85c0aee7dcf7c3a641bfaa079c4c7b5428e298bf))
* fix Debridio scraper ([3f93e1e](https://github.com/iceblinker/comet/commit/3f93e1e783a6b491c5d3837b08eae4fded1cc396))
* fix imdb_id: in media_id ([607b5b3](https://github.com/iceblinker/comet/commit/607b5b38a39b412d73f0e021048735de8dbf4d3f))
...
* Implement database import/export CLI tool ([52efbf1](https://github.com/iceblinker/comet/commit/52efbf176941b92b9497eeaa33c0b90e1dc49f00))
* Implement database import/export CLI tool ([07a0885](https://github.com/iceblinker/comet/commit/07a0885e6928b72707980cacc13f200aec7ec1c0))
...
* Nyaa scraper ([950db79](https://github.com/iceblinker/comet/commit/950db795699c831e0e849d6d29e6d6cf5b0ae3a4))
* Nyaa scraper ([a96986c](https://github.com/iceblinker/comet/commit/a96986cec7a2266bf07685e1a09a63b0646bfff4))
...
* remove normalize_title from metadata handling ([35d2171](https://github.com/iceblinker/comet/commit/35d217168da40f3de20e2ea03c9d29d2c1512ace))
...
* add db connection retry logic for dns errors ([66eca40](https://github.com/iceblinker/comet/commit/66eca4044f64989c4d3f04a19a3c995847811144))
...
* double quote is better ([b9845dc](https://github.com/iceblinker/comet/commit/b9845dc50d86d33ed690b23b401a6f0efbc8abb2))
...
* force connection to resolved IP ([f6df991](https://github.com/iceblinker/comet/commit/f6df9917eb236d8d40631f50021beac4abbbc7d3))
...
* handle missing results count in YGGTorrent scraper ([52c7718](https://github.com/iceblinker/comet/commit/52c7718c0eaf6eeee2264022b268075257eb36f2))
* implement explicit DNS wait loop ([f240ecc](https://github.com/iceblinker/comet/commit/f240ecc9d14d559a0c7bdd9d752537b513f79d69))
* little opti ([c7214f2](https://github.com/iceblinker/comet/commit/c7214f213de8e96ecd06b5a32aa39bad5e23c466))
* manual url reconstruction to preserve creds ([22febc3](https://github.com/iceblinker/comet/commit/22febc389802f30490509a3cf454fdb0b8ed8244))
...
* remove double-nested append ([4763307](https://github.com/iceblinker/comet/commit/47633073f0aec345a3fad7b63a11bb2b9d9c98cf))
...
* remove timeout parameter from anime mapping request ([c37e959](https://github.com/iceblinker/comet/commit/c37e959bfd81910b3ee26f13123d7f6e11773cf5))
* rtn ranking model ([831a0cf](https://github.com/iceblinker/comet/commit/831a0cfeabac55b77f91a0d242ea198d95dba917))
* safely extract query from db url ([4a51d2a](https://github.com/iceblinker/comet/commit/4a51d2a0b0413e878c2319edaff9888bc5b0266e))
...
* Strip 'imdb_id:' prefix from media ID in stream endpoint ([cc5b6a8](https://github.com/iceblinker/comet/commit/cc5b6a8c95d88b5769cce0e2b27d2aa586bfcc07))
...
* update playback route to accept path parameters ([7658949](https://github.com/iceblinker/comet/commit/76589492dc18d2cc9846643e0fe52d5281e687c2))
* update title matching logic in StremThru and TorrentManager ([657748c](https://github.com/iceblinker/comet/commit/657748c1e1973b1000ccbad8383760f84a6bed74))
* Update YGG domain URL ([a9b223f](https://github.com/iceblinker/comet/commit/a9b223f1cd713744693d576c830e9618471b39d0))
* use get method for safer access to seeders, tracker, and sources maps ([43e92a2](https://github.com/iceblinker/comet/commit/43e92a2990dd3002a629e61b02d035b5910a315b))
* use replace() to preserve db credentials ([d403e99](https://github.com/iceblinker/comet/commit/d403e99f06bc039b89aaaa6855ab83c241878b9e))
* use settings.DATABASE_URL for reliable creds ([6275879](https://github.com/iceblinker/comet/commit/62758799be0d080fd667447ccbc4c8fa37e5e9dd))
