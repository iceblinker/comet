...
* add `parsed_matches_target` utility and use it to centralize season/episode filtering logic ([47b79ee](https://github.com/iceblinker/comet/commit/47b79ee7fb0e4131ebe595da37c54be0a0f753a8))
* add `RTN_FILTER_DEBUG` setting to enable verbose logging for torrent filtering rejections ([b9cc11d](https://github.com/iceblinker/comet/commit/b9cc11d109a68bac31732ed1ec7f253ae4ba1463))
* add `RTN_FILTER_DEBUG` setting to enable verbose logging for torrent filtering rejections ([ddaafa2](https://github.com/iceblinker/comet/commit/ddaafa22ca7b73bc62994da33f23bb0560488c3b))
* add `tzdata` package and set `TZ` environment variable to `UTC` ([29ac052](https://github.com/iceblinker/comet/commit/29ac0525a55943612a4e3521acd843ddb7e00f71))
* add AnimeTosho scraper ([1b87b1e](https://github.com/iceblinker/comet/commit/1b87b1e5017d06f59c63990d0ccb1c714a8494b5))
* add API response to IMDB metadata retrieval error logs ([242e83a](https://github.com/iceblinker/comet/commit/242e83a7e1bad5303fa6dfa8298d2fd9c2ec4f22))
* add background and icon image assets ([d9dceab](https://github.com/iceblinker/comet/commit/d9dceabcb071abaaa525e5a0dfae3c9ffd2a1ab2))
* add catalog and magnet resolve timeouts to configuration ([eb3b5e8](https://github.com/iceblinker/comet/commit/eb3b5e87c76729ba15c9110dd068256f3f57bbf6))
* add ChillLink API endpoints and refactor stream description formatting logic ([ec2aa2b](https://github.com/iceblinker/comet/commit/ec2aa2bb170b4bef70dee0ce452f94ab53d44f94))
* add ChillLink Protocol support to README ([8d8c484](https://github.com/iceblinker/comet/commit/8d8c4844cfe24c874260e665945af1a2ffde88da))
* add COMET_CLEAN_TRACKER setting to control tracker list display in Comet scraper ([a35327b](https://github.com/iceblinker/comet/commit/a35327b111b8459926c7c8e3751e2388e16bf0e0))
* add configurable `PROXY_DEBRID_STREAM_INACTIVITY_THRESHOLD` setting to enable and refine the cleanup of inactive debrid stream connections ([cfc0eae](https://github.com/iceblinker/comet/commit/cfc0eaea847779e111b63a26d93f50714d859ab8))
* add configurable `PROXY_DEBRID_STREAM_INACTIVITY_THRESHOLD` setting to enable and refine the cleanup of inactive debrid stream connections ([aef99f4](https://github.com/iceblinker/comet/commit/aef99f43bed584f352c469c143693fdf27eb7b21))
* add configurable reachability check settings including retries, delay, and timeout for improved connection handling ([16f5df4](https://github.com/iceblinker/comet/commit/16f5df4bceb1d2e77286a913eb27f543b62ab25d))
* add configuration and UI option to sort cached and uncached stream results together ([a472595](https://github.com/iceblinker/comet/commit/a4725958d051a11eed651a065578691ec0d2e1d6))
* add configuration and UI option to sort cached and uncached stream results together ([5fda0df](https://github.com/iceblinker/comet/commit/5fda0df1a98f313c49fdd3e65eafd24ae792924e))
* add DATABASE_FORCE_IPV4_RESOLUTION setting and update logging ([4b6c51a](https://github.com/iceblinker/comet/commit/4b6c51af39e1b88c25771fe1b9fc2f4363c441f5))
* add Debrid Account Scraper feature description to README ([4f4e351](https://github.com/iceblinker/comet/commit/4f4e3518e48b01d3d543a2750d44d7f63afbe4c5))
* add DEBRID_CACHE_CHECK_RATIO setting and update availability ch… ([0173711](https://github.com/iceblinker/comet/commit/0173711eeda1dd0cfe121e6b153c124ded8b31b9))
* add DEBRID_CACHE_CHECK_RATIO setting and update availability check logic ([3ecd35a](https://github.com/iceblinker/comet/commit/3ecd35aa9fcfa12de7910a7fc05c4fae05e231f6))
* add debug logging to `_validate_torrent` for various torrent validation failure conditions ([bde663f](https://github.com/iceblinker/comet/commit/bde663f48ad406f9d3e8a3f6de1ae88744d0c157))
* add default PostgreSQL service to Docker Compose, configure Comet to use it, and introduce SQLite concurrency warnings ([24fb50b](https://github.com/iceblinker/comet/commit/24fb50bf77645dfbcf103df78e6e8f51d4855511))
* add DMM to supported scrapers and introduce DMM Ingester feature ([68fa89d](https://github.com/iceblinker/comet/commit/68fa89de2dbb4ab8c7950b8a6cd51dc4308d34e2))
* add external reachability check for COMETNET_ADVERTISE_URL and introduce COMETNET_SKIP_REACHABILITY_CHECK for local testing ([f8983c7](https://github.com/iceblinker/comet/commit/f8983c73970eec309476eef4afd8b48bf3657d09))
* add fallback to check watch providers for movie release dates when upcoming release date is unavailable ([ac2cafb](https://github.com/iceblinker/comet/commit/ac2cafb8abc1c46f8d44c8682f80e0ea0b0cdf2f))
* add fallback to check watch providers for movie release dates when upcoming release date is unavailable ([6b6e466](https://github.com/iceblinker/comet/commit/6b6e466c7d053be137127d38d924e296cc03f192))
* add hostname resolution method to ReplicaAwareDatabase ([81842ba](https://github.com/iceblinker/comet/commit/81842bacf8d5ac4f1be1cffac46c79155e3075a8))
* add HTTP request handling to the WebSocket server for graceful responses to non-WebSocket requests ([4b0a187](https://github.com/iceblinker/comet/commit/4b0a18738b364550500478d379f9f393529f193b))
* add local torrent existence check to optimize gossip validation and enhance message re-propagation ([8e04047](https://github.com/iceblinker/comet/commit/8e04047c58b80791a74e448184427582206bbbea))
* add logging for incoming connection handling in ConnectionManager to track extracted IPs ([fe23a34](https://github.com/iceblinker/comet/commit/fe23a34511e093d959a8ff1c807bea1aba4898e5))
* add manifest and configure page caching settings ([6b9dbcd](https://github.com/iceblinker/comet/commit/6b9dbcdab3672f7890c98895ca50e6bbdfe74832))
* add manifest and configure page caching settings ([60c90bc](https://github.com/iceblinker/comet/commit/60c90bc2e842808c7fbf91d861bcf1a5916fc054))
* add max latency configuration and handling in CometNet to disconnect peers exceeding acceptable latency, enhancing network performance ([39b5e1b](https://github.com/iceblinker/comet/commit/39b5e1b327c593bc2453824c798a7f19e7c33074))
* add method to reset discovery hysteresis in BackgroundScraperWorker for improved task management ([2a97dda](https://github.com/iceblinker/comet/commit/2a97ddafde9b5a9be95e8761b7b8ac0e7d80a4a9))
* add new scraper configurations and clarify the `PROXY_ETHOS` `on_failure` option in the sample environment file ([4a34aad](https://github.com/iceblinker/comet/commit/4a34aad8b7dfc32b18b868f57cbd6b60460e36bb))
* add OpenAPI tags, summaries, and descriptions to API endpoints and parameters ([da1d5a7](https://github.com/iceblinker/comet/commit/da1d5a7fbd6feb9e0e2c9a57d9456fae5744bddb))
* add optional node alias to CometNet ([9af324f](https://github.com/iceblinker/comet/commit/9af324fc9b44d9435f328e966febfe779e7b8f24))
* add periodic state save functionality to CometNetService with configurable interval ([a209467](https://github.com/iceblinker/comet/commit/a2094671d90c5c5c9d4422b5d6c8fc8ebfc14634))
* add persistence for the gossip engine's statistics ([8e71ee2](https://github.com/iceblinker/comet/commit/8e71ee2ffa4cf86e5cf10aa7a1198200c745a70a))
* add PostgreSQL-specific logic for refreshing scrape locks using `RETURNING 1` to confirm update success ([dd8f8de](https://github.com/iceblinker/comet/commit/dd8f8de42a1c8963542d9cf35f70064c6df42ee0))
* add robust error handling to the Prowlarr scraper ([95866a6](https://github.com/iceblinker/comet/commit/95866a68abe0bf4e38c6eab0f6f6576ebbcd37e6))
* add support for cached availability checks across multiple services ([228cba0](https://github.com/iceblinker/comet/commit/228cba0554509fa90068a02fa764f079a8b4266f))
* add support for downloading generic trackers at startup ([4e701d8](https://github.com/iceblinker/comet/commit/4e701d89c8eba70fb9998e9bba932aefc9d677db))
* add timeouts to Prowlarr API requests ([c0d7060](https://github.com/iceblinker/comet/commit/c0d70607b28164f6e29ca7481bf17ea0fa126b64))
* add TorrentsDB scraper and remove redundant `pass` statements in other scrapers ([f486247](https://github.com/iceblinker/comet/commit/f4862470a50b4463f1d287bb48688c8a4ab3e343))
* add TorrentsDB scraper and remove redundant `pass` statements in other scrapers ([c26140d](https://github.com/iceblinker/comet/commit/c26140d6ce5ef0474ca2d1f616af138560f158ed))
* add version information display and update checking functionality to the admin dashboard ([d8c7aa8](https://github.com/iceblinker/comet/commit/d8c7aa8c1395c2f96d256d215964ed8c1a5cbd69))
* add YGGTORRENT_PASSKEY setting and update Yggtorrent scraper to parse info hash from page HTML and use passkey for tracker sources ([c442b0c](https://github.com/iceblinker/comet/commit/c442b0c2691c2022e5da244010e9ae20621faaf2))
* add YGGTORRENT_PASSKEY setting and update Yggtorrent scraper to parse info hash from page HTML and use passkey for tracker sources ([6e44eb2](https://github.com/iceblinker/comet/commit/6e44eb260dcf4354308b9e7c36f61c3c55593f38))
* allow `_scrape_media_type` to signal early termination and stop the scraping loop ([b96fd1f](https://github.com/iceblinker/comet/commit/b96fd1f3de710d2ba70549d1a38f28cd16b5e64b))
* allow configuration of ProcessPoolExecutor max workers with auto-detection and logging ([c6c5c42](https://github.com/iceblinker/comet/commit/c6c5c42b974d6fe50ab3fd196d524345015d5dee))
* allow configuration of ProcessPoolExecutor max workers with auto-detection and logging ([7e98d1f](https://github.com/iceblinker/comet/commit/7e98d1f067b864261c40a871bdc6f98f38c7e0d5))
* allow Kodi setup codes to be 6-16 characters long and update related prompts ([1c5b963](https://github.com/iceblinker/comet/commit/1c5b9634d8e423cc4943191baf17f20bd2b7e2bd))
* anime mapping disabler ([1c0bf9b](https://github.com/iceblinker/comet/commit/1c0bf9bcc4f8e90a5433bf18e8fabd37b309f9ef))
* apply reputation penalty when an invalid hex signature is encountered ([e23d630](https://github.com/iceblinker/comet/commit/e23d63031dd25baf89b0a8c6fa950cf29a5972ac))
* asynchronously validate manifests and canonicalize float values for signature stability, while improving shutdown handling and error logging ([67083f2](https://github.com/iceblinker/comet/commit/67083f22e0214e31e4252c89c80d5192b2af24e1))
* cache public key representations, validate incoming info hashes, and generalize message sending to support raw bytes ([6d74cef](https://github.com/iceblinker/comet/commit/6d74cef8243dd8117b5ed56bd59ed8e9bd0430b8))
* canonicalize pool manifest timestamps to integers for signing to resolve float precision issues ([67240ad](https://github.com/iceblinker/comet/commit/67240adec810ee49afd6dcf2a3043b0aecd908c4))
* ChillLink Support ([b066b54](https://github.com/iceblinker/comet/commit/b066b5495a86191bd08d366f8f198dc190a54974))
* cloudflare cache guide ([331b5e2](https://github.com/iceblinker/comet/commit/331b5e276dcb2bb8200ea7252e41ccee8cf2cce1))
* conditionally apply digital release filter based on settings and remove redundant internal filter check ([489ed9b](https://github.com/iceblinker/comet/commit/489ed9bdbe79aef571cbccb3b3742c4f9162c04e))
* decouple Jackett and Prowlarr scraper configurations from a generic indexer manager ([d17cb2d](https://github.com/iceblinker/comet/commit/d17cb2d7b3b1c3d72f7b2df92a47f853d71a89fd))
* decouple Jackett and Prowlarr scraper configurations from a generic indexer manager ([460fad2](https://github.com/iceblinker/comet/commit/460fad22b48ddcf465fd4f126a244bb1295bec1d))
* derive `node_id` from public key for `PoolMember` and update admin dashboard to display node IDs ([bcd1b14](https://github.com/iceblinker/comet/commit/bcd1b1478ba9466465913b304962cefcc45d3d1a))
* dev to main ([2d2ded3](https://github.com/iceblinker/comet/commit/2d2ded3f6a70b7efce0d134d281809cd8a5f7015))
* display current branch in the admin dashboard version information and visually refresh the version details section ([4b8ad5f](https://github.com/iceblinker/comet/commit/4b8ad5fe85a4930f5fb5ef1147f47e8ada52c1e5))
* display peer torrents received in the admin dashboard and include reputation data in peer information ([1be6218](https://github.com/iceblinker/comet/commit/1be62185a2b24c8b40e67253a0903c4626bc6f03))
* document CometNet P2P network and remove Nginx reverse proxy configuration from README ([f66c0f2](https://github.com/iceblinker/comet/commit/f66c0f22ea836244fc2b629c951622a769b396e5))
* enable dynamic proxy configuration by allowing extra Pydantic settings fields and setting the default proxy ethos to 'always' ([bbeafd7](https://github.com/iceblinker/comet/commit/bbeafd7ac0e975f49bac68cbe0dd7b381b70d13e))
* enable standalone CometNet service to directly save discovered torrents to the database ([9caab14](https://github.com/iceblinker/comet/commit/9caab14a1b4ab31c8c566a0903000d501760d8b0))
* enhance admin dashboard with background scraper next cycle display and controls ([c2ce896](https://github.com/iceblinker/comet/commit/c2ce896cc19fa1378078f83cfcb42aa663a0408f))
* enhance caching policies and improve manifest handling ([463ab41](https://github.com/iceblinker/comet/commit/463ab4154c9a1c39428c1acdbcb9b8bba04aa68a))
* enhance caching policies and improve manifest handling ([23ab2f4](https://github.com/iceblinker/comet/commit/23ab2f44b187f72048376bd3637395d781344276))
* enhance client IP detection by checking multiple headers and validating IP addresses ([a584432](https://github.com/iceblinker/comet/commit/a5844323d9a2fee4454fc88a4202a9c0e9d43519))
* enhance client IP detection by checking multiple headers and validating IP addresses ([b64b7f6](https://github.com/iceblinker/comet/commit/b64b7f6e57f321fad8671a8412b7d919e36285d4))
* enhance client IP retrieval in CometNetService by adding support for WebSocket requests ([b9f3dfa](https://github.com/iceblinker/comet/commit/b9f3dfa8f30ddaed9d67d2dcf187291bfaa086db))
* enhance COMETNET_ADVERTISE_URL validation with security checks for internal domains, private IPs, and port range, and improve reachability checks for public IPs ([2da0020](https://github.com/iceblinker/comet/commit/2da00206b4eb1a52642b0c295c5a0d519e1c712d))
* enhance copyInviteLink function to use async clipboard API with fallback for insecure contexts ([cce81ec](https://github.com/iceblinker/comet/commit/cce81ecd9f70712d949690fc84a605960fa813cf))
* enhance cryptographic verification by adding public key loading and signature verification methods ([5e0afc0](https://github.com/iceblinker/comet/commit/5e0afc0d25411497c1276350844b07584fb5a603))
* enhance database indexing and improve torrent processing efficiency ([add3813](https://github.com/iceblinker/comet/commit/add3813663a6d65c5d893f33161852cb1ba817ad))
* enhance debrid service to enrich torrent metadata from availability checks ([1699808](https://github.com/iceblinker/comet/commit/1699808b479501a7dfc5bcfc00a982452c11b992))
* enhance DebridService with file index coercion and parsed data merging ([fe63e77](https://github.com/iceblinker/comet/commit/fe63e772d7d75cbe4ac8a497105f854991ef3c60))
* enhance error handling in multi-debrid service availability checks ([b1d621a](https://github.com/iceblinker/comet/commit/b1d621ae18b8104d5bdf3f11445afe7bba9d352e))
* enhance formatting functions with customizable styles for components and streamline secret string handling in Kodi setup ([3799022](https://github.com/iceblinker/comet/commit/3799022b6095fb0c3dcee9785022ec83ee2fa300))
* enhance gossip statistics by adding repropagation tracking and updating dashboard labels ([80cc495](https://github.com/iceblinker/comet/commit/80cc4954989fc9a201a91a986cc9697352eb8653))
* enhance handshake logging in ConnectionManager for better debugging and error tracking ([454817e](https://github.com/iceblinker/comet/commit/454817e4b4c3c7e7c8e7a6238b637bc13d97f420))
* enhance info hash normalization with error handling and new format support ([6b9b33d](https://github.com/iceblinker/comet/commit/6b9b33d0325a13f92c5f05d5ce69ea701fe92f66))
* enhance language settings and parsing functionality ([430b630](https://github.com/iceblinker/comet/commit/430b6308a11744cf81e41b6093facbcadacd31e1))
* enhance network manager with proxy hostname resolution for curl_cffi ([65a7464](https://github.com/iceblinker/comet/commit/65a7464acc1cbc84953aac19f99fc8024a984bb0))
* enhance reachability check logic in `check_advertise_url_reachability` to handle hairpin NAT scenarios and improve logging for verification results ([20226ae](https://github.com/iceblinker/comet/commit/20226aed5acfabc9fe0b70d6c9b996abfe3f0bf0))
* enhance state loading to tolerate integrity hash mismatches ([1fe70be](https://github.com/iceblinker/comet/commit/1fe70be76d8018be94b920f60d36b3470448841d))
* enhance system clock synchronization check to use multiple endpoints and provide detailed error reporting ([9f51226](https://github.com/iceblinker/comet/commit/9f51226dd45dd5b09b4444cd0057272a11ada6aa))
* enhance WebSocket connection and handshake logging in ConnectionManager to improve debugging and error tracking ([35f32d6](https://github.com/iceblinker/comet/commit/35f32d674aa4e8a8e49f9583d7f25a85d64a1020))
* enhance WebSocket connection logging in CometNetService for improved client IP tracking ([979a26e](https://github.com/iceblinker/comet/commit/979a26edd797584b756761f255c8041dc59852bb))
* fetch indexer statuses from response ([bd51abf](https://github.com/iceblinker/comet/commit/bd51abf40e9173fe3a366cfa9b5bcc0f91d77767))
* filter episodes based on the retry status of their associated series item ([0696166](https://github.com/iceblinker/comet/commit/06961667fe9053e8755fc49ee0cbcd7c803aa99d))
* fix a few useless things ([1f29c4c](https://github.com/iceblinker/comet/commit/1f29c4ca1ba074f35760ce7549098b68e6b7d778))
* fix aiostreams null infoHash ([880927c](https://github.com/iceblinker/comet/commit/880927c9186d1bb38a6103e5c8c52bfcef41a69a))
* fix slow anime mapper loading ([67f7740](https://github.com/iceblinker/comet/commit/67f774029d0394f53d3999943bbd04e184605065))
* implement a custom Kodi setup dialog with dedicated error alerts and expand the Kodi add-on documentation ([526c6e2](https://github.com/iceblinker/comet/commit/526c6e2c2d55ccfea9a18bf040475e4c499542d2))
* implement a custom Kodi setup dialog with dedicated error alerts and expand the Kodi add-on documentation ([6aaf39d](https://github.com/iceblinker/comet/commit/6aaf39d3e637e330941b40e3bb96c47ad69b4225))
* implement a Kodi repository build system, including a new Makefile, generation script, repository definition, and GitHub Actions workflow ([cd2f6ab](https://github.com/iceblinker/comet/commit/cd2f6ab470eea9154ad73b83549cee9f3121af1e))
* implement and integrate pool member contribution tracking within the PoolStore and record contributions during gossip processing ([f67b941](https://github.com/iceblinker/comet/commit/f67b9419992acc6aa89fee05a3ca2cb0e708d870))
* implement concurrent lock maintenance as a separate task to ensure continuous scraping and robustly handle lock loss ([1172adf](https://github.com/iceblinker/comet/commit/1172adf25896cda2db2157079f928b4caa266fe5))
* implement debrid account torrent scraping ([c36475b](https://github.com/iceblinker/comet/commit/c36475bd7c135c4bf0de637ab167607ffacb0747))
* implement dedicated crypto executor management in utils and shutdown procedure in CometNetService to enhance resource handling ([a944efc](https://github.com/iceblinker/comet/commit/a944efc9c1b7bc26b896f3d38e2b7c83b5f7d4a1))
* implement digital release filtering for movies and series using TMDB ([172fb5b](https://github.com/iceblinker/comet/commit/172fb5b7d454fabf34670daae150d177b439de4e))
* implement digital release filtering for movies and series using TMDB ([e05a0da](https://github.com/iceblinker/comet/commit/e05a0da0665e8bd48a3a6cf7e696f012f74c28ca))
* implement distributed locking for the background scraper and remove the `background_scraper_progress` table ([1b9d8e1](https://github.com/iceblinker/comet/commit/1b9d8e1ac4850b47d159d77f6dbfda95919b0c3d))
* implement dynamic Prowlarr indexer management with initialization wait, update Jackett management, and add related settings and logging ([1152b42](https://github.com/iceblinker/comet/commit/1152b42c2ee072f73607bb9480f83e0993751c1c))
* implement functionality for users to leave CometNet pools with role-based restrictions ([4081d11](https://github.com/iceblinker/comet/commit/4081d1147736f4573984c7e5e013284f14ec97d6))
* implement HTTP caching mechanism ([35eab54](https://github.com/iceblinker/comet/commit/35eab54a7caa68f152583014680e7605619f36d4))
* implement IPv4 hostname resolution in ReplicaAwareDatabase ([ddde28f](https://github.com/iceblinker/comet/commit/ddde28f8a51fa682d9051460c2cd8e15856309b3))
* implement mandatory and auto-generated `COMETNET_API_KEY`, and add auto-generation for `ADMIN_DASHBOARD_PASSWORD` and `PROXY_DEBRID_STREAM_PASSWORD` ([29a8a5a](https://github.com/iceblinker/comet/commit/29a8a5a04decc3f291524140d2308425b8557b03))
* implement membership reconciliation in CometNetService and improve error logging in CometNetRelay ([6cca3f4](https://github.com/iceblinker/comet/commit/6cca3f4ac1c38499c07df9bcbe100293770322b9))
* implement message rate limiting and refactor message security validation into a dedicated module ([0a75780](https://github.com/iceblinker/comet/commit/0a7578009dc7bb1a864726fa9b786556531f4d23))
* implement multi-debrid service support and enhance configuration ([6cadc4d](https://github.com/iceblinker/comet/commit/6cadc4d57595632162118553c7952fc20c367dd6))
* implement multi-debrid service support and enhance configuration ([f6abcf5](https://github.com/iceblinker/comet/commit/f6abcf5e4c38339f14c3cc462782b010bfc90aae))
* implement new pools management UI with filtering and search functionality in admin dashboard ([12c4695](https://github.com/iceblinker/comet/commit/12c46955dae25216d533089d0fdfea4e9e340d9a))
* implement private network mode with HMAC authentication, status display, and enhanced logging ([e154fc0](https://github.com/iceblinker/comet/commit/e154fc0deb482912415a69d9114fa431ce340ec0))
* implement proactive distributed lock refreshing and add error handling for background tasks ([c170fc6](https://github.com/iceblinker/comet/commit/c170fc68a0ae35befd7408d3149c5a7a02f3d483))
* implement queue-based backpressure and discovery pausing for the background scraper using watermarks ([af664a7](https://github.com/iceblinker/comet/commit/af664a716beb19b7863feebc0d70c87628a85bf1))
* implement queue-based backpressure and discovery pausing for the background scraper using watermarks ([6eaff9c](https://github.com/iceblinker/comet/commit/6eaff9c8d8ffd3166d6e87335c3634bdc09b8a9c))
* implement resolution-based selection of info hashes for torrent streaming ([1814efa](https://github.com/iceblinker/comet/commit/1814efa84c0e54ddb93a2ef8ffce224cc398bc40))
* implement seadex scraper and fix anime media id parser ([436de99](https://github.com/iceblinker/comet/commit/436de999f9ef25de8e804af7363e7d6fdb78a648))
* implement self-removal from pools by broadcasting a signed leave message and updating local cleanup logic ([db15cd7](https://github.com/iceblinker/comet/commit/db15cd72cc0bf878b6da9625d8c73c9ce5ec3ee2))
* implement sharded and deduplicated filter parse cache ([fab96ae](https://github.com/iceblinker/comet/commit/fab96ae3a48af71f2d9ab4627475586e14971f27))
* implement smart file selection algorithm and refine torrent record management for multi-episode content ([479b5ae](https://github.com/iceblinker/comet/commit/479b5ae8ff2bc800b9ed8dff0f418189391e1342))
* implement system clock synchronization check on CometNet startup with configurable tolerance and timeout ([51a81e4](https://github.com/iceblinker/comet/commit/51a81e49d38d93aa2cfdd5507b908d31f0902625))
* improve caching and scraping by supporting linked Kitsu and IMDb media IDs and refining season/episode parameters for debrid services ([072dcab](https://github.com/iceblinker/comet/commit/072dcaba45b27468467913258c9ee1c073b06d4f))
* improve client IP extraction in WebSocket connections by introducing get_client_ip_any function and updating connection handling in CometNetService and ConnectionManager ([f2f5838](https://github.com/iceblinker/comet/commit/f2f58389ff1ce7e6f42b1bdc24fa04acb52182b4))
* improve cloudflare cache rules ([1841dce](https://github.com/iceblinker/comet/commit/1841dceaf332587ebb0767d8a55ab7781f129008))
* improve cloudflare guide ([8b8b763](https://github.com/iceblinker/comet/commit/8b8b76324b4f1570512e695918f1266765c712e1))
* improve connection handling in ConnectionManager by closing duplicate connections and reusing existing ones ([bd0a5f4](https://github.com/iceblinker/comet/commit/bd0a5f465bee3720b10db3c9c17659bdcdabf9b0))
* improve data canonicalization by sorting visited nodes and robustly handling dictionary keys, and add debug logging for signature verification ([2c8b3f7](https://github.com/iceblinker/comet/commit/2c8b3f716d540324e088793986dd6e998a1a88d2))
* improve error handling in torrent title parsing ([85fc456](https://github.com/iceblinker/comet/commit/85fc4566c845ea0bd2f4e52fa9ebe3d5cad3d963))
* improve error handling in torrent title parsing ([42a93d4](https://github.com/iceblinker/comet/commit/42a93d4c22df5926f448ff9eadea5b828a2a1418))
* improve Kodi integration with direct VideoInfoTag usage, robust setup, and refined stream info handling ([a62dc06](https://github.com/iceblinker/comet/commit/a62dc062c8334efb5fa65a197a6c784928a42e47))
* improve performance with process pool executor and optimize torrent caching/database writes ([5666a7d](https://github.com/iceblinker/comet/commit/5666a7d019dcb3039ca6d30fa4f6908d6c58dca4))
* improve performance with process pool executor and optimize torrent caching/database writes ([0ce6579](https://github.com/iceblinker/comet/commit/0ce6579f3ff740cf2a91f5c9d6d9ee8eea6b8010))
* improve torrent batch processing with in-memory deduplication, PostgreSQL advisory locks, and enhance metadata handling ([ac061ac](https://github.com/iceblinker/comet/commit/ac061acd71e3d68574f2cb22cdbc06fe705d78f8))
* improve torrent batch processing with in-memory deduplication, PostgreSQL advisory locks, and enhance metadata handling ([45ff7c1](https://github.com/iceblinker/comet/commit/45ff7c173abb49a050c4ba14103fe6beae845d32))
* increase default relay timeout and add specific handling for `asyncio.TimeoutError` during batch sends ([f8819b1](https://github.com/iceblinker/comet/commit/f8819b1c1763869623b4cb7a6b38ebd9cd1dd3e3))
* init cometnet ([748249e](https://github.com/iceblinker/comet/commit/748249e647f58c9bf37c1d069c44802d7a4d5ed7))
* introduce `update_interval` for torrent upsert logic and implement batched upsert for SQLite ([6b83124](https://github.com/iceblinker/comet/commit/6b831243ca289b7ae9323018161e4fb9a092396c))
* introduce a dirty manifest tracking mechanism and `flush_dirty_manifests` method to batch manifest writes ([b37ec8a](https://github.com/iceblinker/comet/commit/b37ec8a2befa921fe62107d4dc18b262d7ec7ebb))
* introduce a Python script for Comet instance uptime monitoring and Discord notifications ([b61f196](https://github.com/iceblinker/comet/commit/b61f196d0b868ea53759363ef3452f622450a8b3))
* introduce configurable exponential backoff for 429 rate limit errors ([b65c285](https://github.com/iceblinker/comet/commit/b65c2857f9894a57939ee6a86833317ea730e983))
* Introduce DMM ingester ([19001ee](https://github.com/iceblinker/comet/commit/19001eeb6b4f6b45e14880a998a2a6ed19df5200))
* introduce IndexerManager service to dynamically update and manage Jackett and Prowlarr indexers ([beacb2a](https://github.com/iceblinker/comet/commit/beacb2a966fc8969aa3070cbc9e0511073d55b6d))
* introduce IndexerManager service to dynamically update and manage Jackett and Prowlarr indexers ([8265cc5](https://github.com/iceblinker/comet/commit/8265cc55aae8b796e18ee8b738e38d98b9a9990c))
* introduce Kodi addon with pairing service, setup utilities, and updated documentation ([d27239d](https://github.com/iceblinker/comet/commit/d27239d8fbd33d5c549345d9c52ff16efb9dc924))
* introduce smart language detection by leveraging country-specific Trakt aliases ([c413428](https://github.com/iceblinker/comet/commit/c4134289e80385b839a22df18c724b7c83369738))
* kitsu offsets ([4af9add](https://github.com/iceblinker/comet/commit/4af9addd7b05f69a16df317b1e5fbe2aa3e62d2b))
* log http cache environment variables on startup ([f6751e5](https://github.com/iceblinker/comet/commit/f6751e529c2ceec3685514f35c2c73c63b143cc7))
* log private addresses announced by incoming peers and add a setting to prevent sharing private IPs during PEX ([7160406](https://github.com/iceblinker/comet/commit/71604060c8ad54e9ea998ace90facb3311b7559e))
* log specific timeout warnings for scraper exceptions instead of general ratelimiting messages. ([311bfae](https://github.com/iceblinker/comet/commit/311bfaee844a51e184d3a99f8fd0c44ab39b57b9))
* nekobt scraper ([da28fc4](https://github.com/iceblinker/comet/commit/da28fc4e5c4c5ae5727b73db73b9e6b5bb0a8f0f))
* new background scraper ([cebb785](https://github.com/iceblinker/comet/commit/cebb785d21058fe9cd70ceaa407add3724d42120))
* optimize PostgreSQL database operations by adding a covering index, enhancing debrid cache upserts with conditional updates, and refactoring torrent manager's advisory locking ([3911533](https://github.com/iceblinker/comet/commit/39115334d81de44c4cb351b05f2fa86f0bab286e))
* optimize queue snapshot retrieval in BackgroundScraperWorker by consolidating database queries and normalizing discovery limits ([dabbee5](https://github.com/iceblinker/comet/commit/dabbee5c5bd749f5d0006edce852481e5d4f7216))
* optimize service availability checks by filtering unique services ([9296da1](https://github.com/iceblinker/comet/commit/9296da1aa22d13503747ad93578fc428505e4fe3))
* pin python version ([566b28d](https://github.com/iceblinker/comet/commit/566b28d13fbfc51031e3f93e83acc65c4774797f))
* populate `sortCachedUncachedTogether` checkbox from settings ([a5698b2](https://github.com/iceblinker/comet/commit/a5698b28ac64996e675dcf49867192286b5a33db))
* record own contributions ([a36a9d1](https://github.com/iceblinker/comet/commit/a36a9d19efff9e93e909306f999b224e5602f06e))
* refactor HTTP client management and enhance caching mechanisms ([4178cda](https://github.com/iceblinker/comet/commit/4178cda8b538641605ef91740e7c524acead6c4e))
* refactor HTTP client management and enhance caching mechanisms ([efca5db](https://github.com/iceblinker/comet/commit/efca5dbfded727e02a5f335ad8e6941151949f3c))
* refactor live torrent caching to differentiate between displaying existing results and triggering new scrapes, and update default cache TTLs ([7dde28d](https://github.com/iceblinker/comet/commit/7dde28d88d409b1549a0dadd5cd4c2cc60bd3552))
* refactor live torrent caching to differentiate between displaying existing results and triggering new scrapes, and update default cache TTLs ([7af6d09](https://github.com/iceblinker/comet/commit/7af6d0980b2f22f9f9e0cf4edb5e236945bc36dd))
* relax connection limits and overrepresentation checks for private IP addresses ([a8cefbd](https://github.com/iceblinker/comet/commit/a8cefbd66ec0cf79dec5f6585f8844ac1059e053))
* remove manifest from cloudflare cache guide ([3ee32c3](https://github.com/iceblinker/comet/commit/3ee32c3badb47e57403021249061fc2e5cf16939))
* remove unused index ([52609ad](https://github.com/iceblinker/comet/commit/52609addaf54c0d6fa6c576cdc191f1a1ffc4a8e))
* remove verbose logging from anime service ([8cd1e0b](https://github.com/iceblinker/comet/commit/8cd1e0bce6795e6b6f1987355a49d38a183677ac))
* schedule debrid account sync tasks as background tasks when warm sync does not time out ([577a83e](https://github.com/iceblinker/comet/commit/577a83eec9cc6a7889d7d0f87ff19c811c017e77))
* seadex anime only ([e15125a](https://github.com/iceblinker/comet/commit/e15125a339b27a7f3c976b6dd140c5da99c41483))
* seadex anime only ([9b36762](https://github.com/iceblinker/comet/commit/9b36762c5ac4d5582b7026631a5f175b8a5a67c0))
* standardize database conflict handling and type checks with new constants, and add cometnet torrent existence batch check callback ([f8e76e9](https://github.com/iceblinker/comet/commit/f8e76e9b1832f23369e2905b5a7c19d52c7fed64))
* super mega powerful ultra anime mapper ([7035b24](https://github.com/iceblinker/comet/commit/7035b24b3ca9cf7d5d190080b03e425f003849ec))
* switch from session-level to transaction-level PostgreSQL advisory locks for database cleanup and batched upserts ([04dfd38](https://github.com/iceblinker/comet/commit/04dfd38c8f892af72d33641ab3b8af900e68b3e3))
* track and handle completion of debrid account sync background tasks ([041a3ac](https://github.com/iceblinker/comet/commit/041a3acc0e658647e5bf8603979fc3901ef6a353))
* update BitMagnet scraper to use IMDb ID and media type for queries ([3ef2d34](https://github.com/iceblinker/comet/commit/3ef2d3454bbd456da43ff29c21e125e2e51a1f27))
* update BitMagnet scraper to use IMDb ID and media type for queries ([f53c53b](https://github.com/iceblinker/comet/commit/f53c53ba1726e2f88f747b0395aee9d462130811))
* update canonicalization to preserve float precision and add signature verification debug logs ([f1e871e](https://github.com/iceblinker/comet/commit/f1e871e8abcb2d5542ab07a5bc81d9300e1ad516))
* update comet scraper stream endpoint path ([0f3a96f](https://github.com/iceblinker/comet/commit/0f3a96f5fdee2cbecdd48b3090504ea5b52a13f3))
* update image URLs from Imgur to ImgBB ([9f3649f](https://github.com/iceblinker/comet/commit/9f3649fe9eb191fd35b03264421163204ca044b6))
* update image URLs from Imgur to ImgBB ([01db8a8](https://github.com/iceblinker/comet/commit/01db8a8ceb941b03dffd1c355e1461bcf151d142))
* update Kodi integration with new configuration handling, improved manifest URL generation, and enhanced user prompts ([43964ac](https://github.com/iceblinker/comet/commit/43964accbc8e80c570acc843bc0175b4caed0aa0))
* update resolution options ([212d874](https://github.com/iceblinker/comet/commit/212d8744c177ecd7cbfd636c3f8eecf25eb10cfb))
* update resolution options ([53961ef](https://github.com/iceblinker/comet/commit/53961ef442ec689ca4bc2aa51efbba3b1323c547))
* version and update checker ([7c9842a](https://github.com/iceblinker/comet/commit/7c9842a937ab117c02913141bd24d9a09c211a83))


### Bug Fixes

* `_save_manifest_async` now returns a boolean, allowing `flush_dirty_manifests` to re-queue failed manifest saves ([cfb648a](https://github.com/iceblinker/comet/commit/cfb648a06cd99c30aaaf1f3be6721ac410a7a687))
* add check for existing info_hash in torrents before processing ([06bbe9b](https://github.com/iceblinker/comet/commit/06bbe9bbd84cd4f632f3115500a4219864414b54))
* add db connection retry logic for dns errors ([90d8381](https://github.com/iceblinker/comet/commit/90d838146b0e44ca36ec2bfa6c4a9b973c05efc3))
* add error handling for torrent title extraction and unreleased content in comet scraper ([7db932f](https://github.com/iceblinker/comet/commit/7db932ff66c86c3fd30502f5bdadb2a703b88bf7))
* add explicit BIGINT casting to timestamp comparisons in cache cleanup queries ([a52e5c0](https://github.com/iceblinker/comet/commit/a52e5c06a57f6c7d36d2eeb6cf68779b9a6d92f5))
* add HTTP status error handling to AnimeTosho and correct status attribute usage in Nyaa ([b188eda](https://github.com/iceblinker/comet/commit/b188edadd5e0d5d0cdb06ccac2a99e65abba80e7))
* add rust and cargo for cryptg build ([e9b6ac1](https://github.com/iceblinker/comet/commit/e9b6ac1bbc06871dc54a4f277a2fbccac55bebe5))
* adjust background scraper cycle timing to account for missed cycles ([39da5c5](https://github.com/iceblinker/comet/commit/39da5c5d2ed3182587902f444f8a26458d61280f))
* background scraper can't scrape tv shows ([620dca3](https://github.com/iceblinker/comet/commit/620dca33c87511e7f8c4b43feaccf3ec47c94224))
* broaden WebSocket noise error filtering ([47b4657](https://github.com/iceblinker/comet/commit/47b465729b3922cb261082674d8e8e9804d21ca6))
* CachedJSONResponse overwrites body after init ([72bb885](https://github.com/iceblinker/comet/commit/72bb8859a70152e1f4aea3188354d2e8ef66b8cc))
* chunk `execute_many` calls for SQLite to respect its parameter limit ([2352aa6](https://github.com/iceblinker/comet/commit/2352aa6a0f0e138b9d4c586903e1ff028fbafaa1))
* cinemata no releaseInfo ([5f1ca3e](https://github.com/iceblinker/comet/commit/5f1ca3ea53a657567b7dd04e30fd8a5f167437cc))
* clear trackers list before downloading new data ([d396007](https://github.com/iceblinker/comet/commit/d396007a1954f7f25506f7585a51b8fa1484c408))
* correct formatting in README.md ([8ff725d](https://github.com/iceblinker/comet/commit/8ff725dc63740c330bd1fd0228d5bffac331f1b1))
* correct PostgreSQL data volume mount path in docker-compose.yml ([7ae3788](https://github.com/iceblinker/comet/commit/7ae3788a5cc81764297588b83dadb939aef6cac1))
* correct tracker extraction logging for SeaDex scraper ([44aa0d8](https://github.com/iceblinker/comet/commit/44aa0d840b71b1ca5e543b3373cd3db23ec36a96))
* correct typo in DATABASE_FORCE_IPV4_RESOLUTION comment in .env-sample ([f80430d](https://github.com/iceblinker/comet/commit/f80430d706c208cc2c2fd25b6ad47918a7014a37))
* correctly handle `None` values for season and episode parameters in API requests for bitmagnet ([9b91793](https://github.com/iceblinker/comet/commit/9b9179371daf0e91f345b328dfda309941f68724))
* D ([721fa0f](https://github.com/iceblinker/comet/commit/721fa0fcffe9c289594d4e02d2e86f4f2772edb0))
* default `name_query` parameter to an empty string instead of `None` ([49a7302](https://github.com/iceblinker/comet/commit/49a7302066d6f470a5b5efa8a7b62d702bf07971))
* **docker:** add make to build dependencies for miniupnpc ([2fcb2ef](https://github.com/iceblinker/comet/commit/2fcb2ef4b82d58fdf59087354124578ea9d1643f))
* **docker:** increase uv timeout to 300s to avoid network errors ([dc98727](https://github.com/iceblinker/comet/commit/dc987272af34f939db0f11a8f2a28129907f7927))
* ensure default last_seen time is used when sorting keys in PublicKeyStore ([b7bf69e](https://github.com/iceblinker/comet/commit/b7bf69e620d6b89bed05f7e72fe8b8bfda169dbb))
* ensure proper cancellation of in-flight tasks in BackgroundScraperWorker during cancellation ([5d4c5fd](https://github.com/iceblinker/comet/commit/5d4c5fd70ac1f004b90e01f67ea5634230fc19c3))
* ensure proper lock refresh handling and add read timeout for DMM hashlist downloads. ([bbf2639](https://github.com/iceblinker/comet/commit/bbf2639ca6c34aeafdd3e6b25e356c56f0aff52b))
* ensure proper shutdown and tracking of relay batch flush tasks and reorder README features ([53b9c61](https://github.com/iceblinker/comet/commit/53b9c61b277548e095bd4a6934aee2b1119020da))
* ensure season and episode checks in `parsed_matches_target` handle None values correctly ([0a9ace9](https://github.com/iceblinker/comet/commit/0a9ace9db0efef99823497bcbaa0a9bfd5072a75))
* ensure TorrentMetadata size is an integer and sort pool members by public key for deterministic serialization ([5fe3307](https://github.com/iceblinker/comet/commit/5fe330795582ff37607421d89fdf57d014dc7970))
* ETag caching broken by random manifest ID ([e74c29f](https://github.com/iceblinker/comet/commit/e74c29fdd187a2dc8de257d70c09e30924ea70bf))
* exclude subscribed and member pools from the discover count calculation ([37e7e6f](https://github.com/iceblinker/comet/commit/37e7e6f5c1dd07c21eea9e6b21d8dcaf4d4954c1))
* filter private IPs from PEX and warn on misconfiguration ([7ee5b20](https://github.com/iceblinker/comet/commit/7ee5b208c61a54dd9ab43d89868f528ab8212c5b))
* first search emptying itself when torrent cache ttl is -1 ([9237b8c](https://github.com/iceblinker/comet/commit/9237b8c7065f77500a5486311a2495ac96bb7dd7))
* fix _persist_kitsu_imdb_mapping method ([40a8fc3](https://github.com/iceblinker/comet/commit/40a8fc387e0c5ce5200c9e0dd5f5a02965ad4bf8))
* fix various memory leaks ([3798971](https://github.com/iceblinker/comet/commit/37989716c5388c0acdfd0dfc204e87ae0587d907))
* fix volume on official docker compose ([820ebf0](https://github.com/iceblinker/comet/commit/820ebf0ae3d1f577add6fb8ff48df122f66d647f))
* fix wrong ranking order in p2p mode ([d4d7e60](https://github.com/iceblinker/comet/commit/d4d7e6091c3af431c3e5cbb9ec9bc48218b252d4))
* force connection to resolved IP ([b0e5f1b](https://github.com/iceblinker/comet/commit/b0e5f1b7851350ca407d5e6568e6d496681cdef6))
* gracefully cancel and drain in-flight scraping tasks upon lock loss instead of abruptly stopping ([2268e8f](https://github.com/iceblinker/comet/commit/2268e8f106fb7fd2c77d4adfd34134cb01ffb7f4))
* gracefully handle UnicodeEncodeError during filename processing in DMM ingester ([6e68a93](https://github.com/iceblinker/comet/commit/6e68a9398460fe9cedc2494148d91f67769de3d9))
* handle 404 response in Peerflix scraper ([7fa0c2b](https://github.com/iceblinker/comet/commit/7fa0c2bb4b690a860f6195d47dc1ad2572e6cecc))
* handle tracker extraction more robustly by ensuring it defaults to None when not present ([7fd92bc](https://github.com/iceblinker/comet/commit/7fd92bc83ffdbad082ce94d0d4aaf5db1967f6b6))
* implement explicit DNS wait loop ([cd9a5ea](https://github.com/iceblinker/comet/commit/cd9a5ea827535068cf52ab95c5505a84e104b579))
* improve error handling for WebSocket connections with detailed logging ([1c536c8](https://github.com/iceblinker/comet/commit/1c536c8b126b513762433d55618aee11e9fdf8d6))
* little opti ([c7214f2](https://github.com/iceblinker/comet/commit/c7214f213de8e96ecd06b5a32aa39bad5e23c466))
* manual url reconstruction to preserve creds ([9c32cbc](https://github.com/iceblinker/comet/commit/9c32cbc332088867bc9444c9189ee808bd83b417))
* pin mediaflow-proxy dependency to version 2.4.1 for compatibility ([a69a1df](https://github.com/iceblinker/comet/commit/a69a1dfefa5de052a2cfc1bee50bd90ef19e28d9))
* pool join ([c09a143](https://github.com/iceblinker/comet/commit/c09a14374c815405d0e1f044844499398f1abb73))
* postgres ([11aef0f](https://github.com/iceblinker/comet/commit/11aef0f98525e1f05fd22010077d16a6abc8be22))
* potential race can drop queued broadcasts during timeout shutdown ([92aadf3](https://github.com/iceblinker/comet/commit/92aadf32daf531b6cf418ce6b1962883e3ae9f3c))
* preserve original traceback when re-raising exceptions ([b1cf30b](https://github.com/iceblinker/comet/commit/b1cf30b4e82f51ec6695e10efde4589979220f09))
* preserve quality and languages from original parsed data in DebridService ([3f93efb](https://github.com/iceblinker/comet/commit/3f93efb19b504a30cb78b0f23f74b003fef00756))
* prevent CometNet from starting with multiple FastAPI workers in non-relay mode ([a76a36a](https://github.com/iceblinker/comet/commit/a76a36acc11d51d03917debd627073a414758c0e))
* prevent CometNet startup with private advertise URLs on public networks unless explicitly allowed ([e6c8a4c](https://github.com/iceblinker/comet/commit/e6c8a4c57a6c2d39b3dcd47fc3725668e857ad63))
* print full traceback for exceptions occurring during the scraping cycle ([0bf3390](https://github.com/iceblinker/comet/commit/0bf3390dfe55564e73b8bf66ab22d7c5613507d4))
* remove `OR_IGNORE` from the `first_searches` INSERT statement ([390b452](https://github.com/iceblinker/comet/commit/390b45223870954aa1ab63832fef8461407450eb))
* remove 60-second minimum for live torrent cache update interval calculation ([0b27e3c](https://github.com/iceblinker/comet/commit/0b27e3cb4d43f26d45840a4aa5efa84ada7d113c))
* remove early exit when torrent content is not digitally released ([9137096](https://github.com/iceblinker/comet/commit/913709628874699eb6664c5a4e5005a8cf98396e))
* remove ellipsis from truncated node ID displays in the admin dashboard ([96e333d](https://github.com/iceblinker/comet/commit/96e333d01960442d5671010d5559c6133a5fc488))
* remove fake config from comet scraper ([b5856b6](https://github.com/iceblinker/comet/commit/b5856b6554f04d4d9fc4cb0bc5f9d6da93dd9c36))
* remove signal handler ([bad47c4](https://github.com/iceblinker/comet/commit/bad47c45030206329805d41a8f6127608ab57c55))
* remove the update check interval and related logic to always perform an update check ([9327826](https://github.com/iceblinker/comet/commit/9327826ed497b8678a9989942352ef2955cad92d))
* safely extract query from db url ([4a4d526](https://github.com/iceblinker/comet/commit/4a4d5262efc6419e555007a6a7ede65a76baa97a))
* set default max executor workers to 1 ([e683637](https://github.com/iceblinker/comet/commit/e6836374eccf51feb7ea2ee3e1f6e06f8bc1f013))
* suppress unsupported HTTP method HEAD errors from websockets logs using a new filter ([de4cd80](https://github.com/iceblinker/comet/commit/de4cd808ba202d9b6123010f2b76ad9e8bab3cd2))
* tracker extraction result is discarded ([9448806](https://github.com/iceblinker/comet/commit/9448806ea5a8ad1fd7581d8353ad9c72d0ae2f01))
* update anime_entries insert query to handle conflicts by updating existing data ([fa15430](https://github.com/iceblinker/comet/commit/fa15430ba298a20f14756a81dc3bd6a37aa4e60f))
* update asset URLs from ibb.co to GitHub raw content ([77c9f04](https://github.com/iceblinker/comet/commit/77c9f043c32a59eeee53ae123323ce1afb3eed75))
* update contribution recording logic in `PoolStore` to allow contributions to be recorded across all pools if no specific pool ID is provided, enhancing flexibility in member contribution tracking ([2887a22](https://github.com/iceblinker/comet/commit/2887a223b995f40d6017412dc2dce09535c76f94))
* update digital_release_cache.release_date column type to BIGINT ([7219330](https://github.com/iceblinker/comet/commit/7219330bbe0fdefd292f7b90cce18b5286a2d756))
* update lock expiration logic in DistributedLock to refresh based on current loop time ([372efe2](https://github.com/iceblinker/comet/commit/372efe28b999eb85129170cae5ecd05e9d6dcb8e))
* use replace() to preserve db credentials ([fc53f45](https://github.com/iceblinker/comet/commit/fc53f45ecdad9629607a1dce93933818b56a2fc8))
* use settings.DATABASE_URL for reliable creds ([370ce82](https://github.com/iceblinker/comet/commit/370ce82054061366e5ee4ac84d81ffc5338939d2))


### Performance Improvements

* add `idx_torrents_info_hash` for improved lookup performance ([b669b37](https://github.com/iceblinker/comet/commit/b669b379c07ba28c8ea8abdff058b77786e1b350))
* add index on torrents (info_hash, season) to optimize concurrent DELETE operations ([980fe19](https://github.com/iceblinker/comet/commit/980fe194f63003bc464fe5ac0919f804d3171698))
* convert key network discovery and cryptographic operations to asynchronous to prevent event loop blocking ([73af287](https://github.com/iceblinker/comet/commit/73af2875f2e49e64918cddc5bf49cdd5caf29926))
* offload CPU-bound cryptographic operations to an executor, optimize torrent batch processing, and cache public key data ([6a9f9fd](https://github.com/iceblinker/comet/commit/6a9f9fdf2d16e0a4e91dd5ecb03670db29a52dcf))
* reduce RTN parsing chunk size to 20 and rework ProcessPoolExecutor system ([32e5127](https://github.com/iceblinker/comet/commit/32e5127dd322b487948557c5b5a077e8548802e1))
* remove conditional check for empty `sanitized_rows` before `execute_many` database call ([f1d3ea3](https://github.com/iceblinker/comet/commit/f1d3ea3bdbee02a06785e9ae60f2bfd64d6f06e7))
* remove PostgreSQL covering index `idx_torrents_covering` for torrents table ([4f0be0a](https://github.com/iceblinker/comet/commit/4f0be0a786681cfac1f8e43d98c538abdf762cb9))
* remove torrent debrid service short-circuit ([04386ed](https://github.com/iceblinker/comet/commit/04386ed619036842e47ce2b3140d3eff198523ca))
* use non-blocking advisory locks and conditionally insert rows based on lock acquisition ([fb47fa5](https://github.com/iceblinker/comet/commit/fb47fa51f862ee68b483d250555346455e8d3f56))
* use non-blocking advisory locks and conditionally insert rows based on lock acquisition ([60ff4be](https://github.com/iceblinker/comet/commit/60ff4be61c84fabfce1d664ed464a42f3006e6eb))
